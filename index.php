        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h5 class="card-title fs-3 mb-3">Gempabumi Terkini</h5>
                <?php
                  ...
                  <div class="col-md-12 mb-4">
                    <div class="bg-info text-dark p-3 highlight">
                      ...
                      <div class="row p-1">
                        ...
                        <div class="col-md-6">
                          <b>
                            <p class="mb-0"><?= $data->Wilayah ?></p>
                          </b>
                        </div>
                        <div class="col-md-3">
                          <img src="https://data.bmkg.go.id/DataMKG/TEWS/<?= $data->Shakemap ?>" width="200px" alt="Shakemap">              
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <table class="table table-striped data">
                      ...
                      <tbody>
                        <?php
                          $gempa = "https://data.bmkg.go.id/DataMKG/TEWS/gempadirasakan.xml";
                          $temp = file_get_contents($gempa);
                          $xml = simplexml_load_string($temp);
                          $index = 1;
